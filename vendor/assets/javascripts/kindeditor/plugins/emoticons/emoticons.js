...
KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        initImgBox(faceBox['tab0'], 'ac_00', 54);   //有多少个表情
        ...
        //大对象
        FaceHandler = {
            imageFolders: { tab0: 'ac/', tab1: 'tsj/', tab2: 'ldw/', tab3: 'bobo/', tab4: 'babycat/', tab5: 'face/', tab6: 'youa/' },
            imageWidth: { tab0: 35, tab1: 35, tab2: 35, tab3: 35, tab4: 35, tab5: 35, tab6: 35 },
            imageCols: { tab0: 10, tab1: 11, tab2: 11, tab3: 11, tab4: 11, tab5: 11, tab6: 11 },
